...
rect2(rectangle2i A){
    ...
    rectangle2 Result;
    Result.Min = {(r32)A.MinX,(r32)A.MinY};
    Result.Max = {(r32)A.MaxX,(r32)A.MaxY};
    return (Result);
}
inline rectangle2i
rect2i(rectangle2 A){
    ...
    rectangle2i Result;
    Result.MinX = (int32)A.Min.x;
    Result.MaxX = (int32)A.Max.x;
    Result.MinY = (int32)A.Min.y;
    Result.MaxY = (int32)A.Max.y;
    return (Result);
}
