...
/*  
  ...
  [1]Implement live code editing
  [0]Implement music loading
  [0]loading assets
  [0]maybe virtual file system --  Physfs
  [0]other stuff maybe
  [0]capped framerate - 60 FPS  -- Not an issue 
*/
...
loadgamecode(const char* dllname)
{
    ...
    if(Result.GameCodeDLL)
    {
        ...
        func = "GameGetSoundSamples";
        Result.GetSoundSamples =(game_get_sound_samples*)SDL_LoadFunction(Result.GameCodeDLL,func);
    }
    else
    {
...
int main(int argc, char **argv){
    ...
    SDL_Window *Window = SDL_CreateWindow("Game SDL",10,10,WindowWidth,WindowHeight,SDL_WINDOW_OPENGL|SDL_WINDOW_SHOWN|SDL_WINDOW_RESIZABLE);
    ...
    GameMemory.TransientStorageSize = Gigabytes(6);
